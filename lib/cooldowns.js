...
class SPCooldowns {
	...
	load() {
		...
		hook('S_START_COOLTIME_SKILL', 4, handle)
		// hook('S_DECREASE_COOLTIME_SKILL', 4, handle)  --- Commented out as not available in 46.05
		hook('S_LOAD_TOPO', 'raw', () => { this.reset() })
		hook('S_PLAYER_STAT_UPDATE', 12, handleCampfire)
